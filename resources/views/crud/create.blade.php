...
<div class="row">
    <div class="col-lg-12">
        <div class="pull-left">
            <h2 style="margin: auto;">Create Page</h2>
       </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Your full Name" value="{{ old('name') }}">
